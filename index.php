...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="content">
            <?php if ($page == 'infos') { ?>
                ...
                <p><?php echo ($lang['MOD_XTENSE_FIREFOX']); ?> : <a href="https://addons.mozilla.org/fr/firefox/addon/xtense-we/" target="_blank" rel="noopener"><?php echo ($lang['MOD_XTENSE_FIREFOX_LINK']); ?></a></p>
                <p><?php echo ($lang['MOD_XTENSE_CHROME']); ?> : <a href="https://chrome.google.com/webstore/detail/xtense-gm/mkcgnadlbcakpmmmdfijdekknodapcgl?hl=fr" target="_blank" rel="noopener"><?php echo ($lang['MOD_XTENSE_CHROME_LINK']); ?></a></p>
                <p><a href="https://wiki.ogsteam.eu/doku.php?id=fr:ogspy:documentationxtense" target="_blank" rel="noopener"><?php echo ($lang['MOD_XTENSE_INSTALL_HELP']); ?></a></p><br>
                ...
                <p class="c">
                    <input type="text" class="infos" id="plugin_url" name="plugin" value="" onclick="this.select();" readonly />
                </p>
                <p><label for="plugin"><strong><?php echo ($lang['MOD_XTENSE_PASSWORD']); ?></strong></label></p>
                <p class="c">
                    <input type="text" class="infos" id="plugin_password" name="password" value="<?php echo $my_user_token ?>" onclick="this.select();" readonly />
                </p>
                <p><?php echo ($lang['MOD_XTENSE_PSEUDO_PASSWORD']); ?></p><br>
                <div id="actions">
                    <h2><?php echo ($lang['MOD_XTENSE_ACTIONS']); ?></h2>
                    <p>
                        <a href="?action=xtense&action_xtense=renew_token" class="action" title="Effectuer cette action">&nbsp;</a>
            ...
            <?php } elseif ($page == 'group') { ?>
                ...
                <p style="text-align:right;" class="p10"><span onclick="set_all(true);" style="cursor:pointer;"><?php echo ($lang['MOD_XTENSE_TICKALL']); ?></span>
                    / <span onclick="set_all(false);" style="cursor:pointer;"><?php echo ($lang['MOD_XTENSE_UNTICKALL']); ?></span></p>
                    ...
                    <table width="100%">
                        ...
                        <?php foreach ($groups as $l) { ?>
                            <tr>
                                ...
                                <td class="c"><input type="checkbox" name="system_<?php echo $l['group_id']; ?>" id="system_<?php echo $l['group_id']; ?>" <?php if ($l['system'] == 1) echo 'checked="checked"'; ?> />
                                </td>
                                <td class="c"><input type="checkbox" name="ranking_<?php echo $l['group_id']; ?>" id="ranking_<?php echo $l['group_id']; ?>" <?php if ($l['ranking'] == 1) echo 'checked="checked"'; ?> />
                                </td>
                                <td class="c"><input type="checkbox" name="empire_<?php echo $l['group_id']; ?>" id="empire_<?php echo $l['group_id']; ?>" <?php if ($l['empire'] == 1) echo 'checked="checked"'; ?> />
                                </td>
                                <td class="c"><input type="checkbox" name="messages_<?php echo $l['group_id']; ?>" id="messages_<?php echo $l['group_id']; ?>" <?php if ($l['messages'] == 1) echo 'checked="checked"'; ?> />
                                </td>
    ...
    <div id="foot"><?php echo round($php_timing, 2); ?> ms - <a href="https://forum.ogsteam.eu/" onclick="return winOpen(this);" target="_blank" rel="noopener"><?php echo ($lang['MOD_XTENSE_SUPPPORT']); ?></a>
    </div>
</body>
