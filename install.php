...
$db->sql_query("UPDATE ".TABLE_MOD." SET menu = '<span onclick=\"window.open(this.parentNode.href, \'Xtense\', \'width=750, height=550, menubar=no, resizable=yes, scrollbars=yes, status=no, toolbar=no\'); return false;\">Xtense</span>' WHERE title = 'xtense'");
	...
	else
	{
        ...
        mod_create_table("CREATE TABLE IF NOT EXISTS ".TABLE_PARSEDREC." (
        ...
        mod_create_table("CREATE TABLE IF NOT EXISTS ".TABLE_PARSEDSPYEN." (
        ...
        mod_create_table("CREATE TABLE IF NOT EXISTS `".TABLE_XTENSE_CALLBACKS."` (
        ...
        mod_create_table("CREATE TABLE IF NOT EXISTS `".TABLE_XTENSE_GROUPS."` (
