...
if ($is_ok == true)
{
	...
	else
	{
		...
		$db->sql_query("CREATE TABLE IF NOT EXISTS `".TABLE_XTENSE_CALLBACKS."` (
			...
			`type` enum('overview','system','ally_list','buildings','research','fleet','fleetSending','defense','spy','ennemy_spy','rc','rc_cdr', 'msg', 'ally_msg', 'expedition', 'trade', 'trade_me','ranking_player_fleet','ranking_player_points','ranking_player_research','ranking_ally_fleet','ranking_ally_points','ranking_ally_research','hostiles') NOT NULL,
