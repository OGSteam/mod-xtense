...
switch ($pub_type){
	...
	case 'android': // RÈcupÈration des donnÈes pour android		  
		Check::data(isset($pub_action));
				
		switch($pub_action){
			case 'attacks':
				/*******************************************************
				 ***  RÈcuperation des donnÈes venant du mod Hostiles ***
				 ********************************************************/	
				//On vÈrifie que le mod Hostile est activÈ
			...
			case 'ally': // DÈtails alliance
				/*******************************************************
				 ***  RÈcuperation des donnÈes d'alliance ***
				********************************************************/
				$alliance=array();
			...
			case 'spys':
				/*******************************************************
				***  RÈcuperation des donnÈes des espionnages ***
				********************************************************/
