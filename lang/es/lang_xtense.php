...
$lang['MOD_XTENSE_DOWNLOAD'] = "Descargar registro";
$lang['MOD_XTENSE_FIREFOX'] = "Firefox versión (Obtener la última versión y abrir el archivo con Firefox)";
$lang['MOD_XTENSE_FIREFOX_LINK'] = "Módulo de Xtense";
$lang['MOD_XTENSE_CHROME'] = "Versión de Chrome";
$lang['MOD_XTENSE_CHROME_LINK'] = "Módulo de Xtense en Chrome Web Store";
$lang['MOD_XTENSE_CONNECTION_DETAILS'] = "Esta es la información que debe especificar el plugin Xtense para conectarse a este servidor";
$lang['MOD_XTENSE_URL_UNIVERSE'] = "URL del universo";
$lang['MOD_XTENSE_URL_PLUGIN'] = "URL del plugin de OGSpy";
$lang['MOD_XTENSE_PSEUDO_PASSWORD'] = "Es necesario que el nick y la contraseña sea la de OGSpy";
$lang['MOD_XTENSE_UPDATE_DONE'] = "La actualización se ha completado";
$lang['MOD_XTENSE_REPAIR_DONE'] = "El espacio personal se ha arreglado correctamente";
...
$lang['MOD_XTENSE_WRONG_CALLBACKS'] = "Algunas modificaciones podrían no instalarse de forma automática";
$lang['MOD_XTENSE_ALLOW_CONNECTIONS'] = "Habilitar la conexión al plugin";
$lang['MOD_XTENSE_ALLOW_ADMIN_ONLY'] = "Limitar la administración al admin (no a los co-administradores)";
$lang['MOD_XTENSE_SPYREPORTS_AUTODELETE'] = "Eliminación automática de RE demasiado viejo (configurable desde el administrador de OGSpy).";
...
$lang['MOD_XTENSE_SPYREPORTS'] = "Reportes de espionajes";
...
$lang['MOD_XTENSE_GROUPS_DEFINITION'] = "Puedes establecer para cada acceso OGSpy que los usuarios tienen Xtense.";
$lang['MOD_XTENSE_UPDATE_DONE'] = "La actualización se ha completado";
