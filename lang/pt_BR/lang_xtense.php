...
$lang['MOD_XTENSE_DOWNLOAD'] = "Download da barra";
$lang['MOD_XTENSE_FIREFOX'] = "Versão Firefox (Recupere a última versão e abra o ficheiro com o Firefox)";
$lang['MOD_XTENSE_FIREFOX_LINK'] = "Módulo Xtense";
$lang['MOD_XTENSE_CHROME'] = "Versão Chrome";
$lang['MOD_XTENSE_CHROME_LINK'] = "Módulo Xtense Chrome Store";
$lang['MOD_XTENSE_CONNECTION_DETAILS'] = "Seguem as informações que você deve usar no plugin Xtense para se conectar ao servidor";
$lang['MOD_XTENSE_URL_UNIVERSE'] = "URL do universo";
$lang['MOD_XTENSE_URL_PLUGIN'] = "URL plugin OGSpy";
$lang['MOD_XTENSE_PSEUDO_PASSWORD'] = "Você deve também inserir seu apelido e sua senha de conexão OGSpy";
...
$lang['MOD_XTENSE_WRONG_CALLBACKS'] = "Alguns links não foram automaticamente instalados";
$lang['MOD_XTENSE_ALLOW_CONNECTIONS'] = "Autorizar as conexões ao plugin";
$lang['MOD_XTENSE_ALLOW_ADMIN_ONLY'] = "Limitar a administração ao admin (e não aos co-admins)";
$lang['MOD_XTENSE_SPYREPORTS_AUTODELETE'] = "Apagamento automático dos RE muito antigos (configurável pelo admin do OGSpy).";
...
$lang['MOD_XTENSE_GROUPS_DEFINITION'] = "Você pode definir para cada grupo do OGSpy os acessos que terão os usuários Xtense.";
$lang['MOD_XTENSE_UPDATE_DONE'] = "Atualização efetuada";
